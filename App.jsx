...
import { useGLTF, MeshReflectorMaterial, BakeShadows, Loader } from '@react-three/drei'
import { EffectComposer, Bloom, DepthOfField, ToneMapping } from '@react-three/postprocessing'
import { easing } from 'maath'
import { Instances, Computers } from './Computers'

const suzi = 'https://cdn.jsdelivr.net/gh/pmndrs/assets@main/models/bunny.glb'
...
function Bun(props) {
  ...
  if (!nodes || !nodes.mesh) return null
  return (
